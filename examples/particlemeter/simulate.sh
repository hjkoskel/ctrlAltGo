...
#Set to bad
qemu-system-x86_64 -kernel ../bzImage -initrd initramfs -device qxl -serial pty -netdev user,id=mynet0,hostfwd=tcp::8080-:80 -device e1000,netdev=mynet0 -rtc base=2006-06-06
