...
qemu-system-x86_64 -kernel ../../examples/bzImage -initrd initramfs -device qxl -serial pty -netdev user,id=mynet0,hostfwd=tcp::4242-:4242 -device e1000,netdev=mynet0 -rtc base=2006-06-06
